...
class picking_Trainer:
    ...
    def __init__(
        ...
        self.ob = SlacObservation((3, 84, 84), (6,), (2,),  num_sequences)
        self.ob_test = SlacObservation((3, 84, 84), (6,), (2,), num_sequences)
    ...
    def evaluate(self, step_env):
        ...
        for i in range(self.num_eval_episodes):
            ...
            while not done:
                ...
                img = state[0][0]
                tactile = state[1]
                self.ob_test.append(img, tactile, action[2:4])
